...
import cors from "cors"; // Importa o middleware de cors para permitir a interação entre o front-end e o back-end de forma segura
...
const routes = (app) => {
  ...
  // Habilita o middleware Multer para lidar com uploads de arquivos
